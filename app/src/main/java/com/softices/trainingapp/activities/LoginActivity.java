...
public class LoginActivity extends AppCompatActivity implements OnClickListener {
    ...
    public void validate() {
        ...
        if (!(mail.matches("^([a-zA-Z0-9_\\-\\.]+)@([a-zA-Z0-9_\\-\\.]+)\\.([a-zA-Z]{2,5})$"))) {
            ...
            Toast.makeText(LoginActivity.this, getString(R.string.toast_error_password), Toast.LENGTH_SHORT).show();
        } else {
            Boolean isLogin = db.checkUsr(edtEmail.getText().toString().trim(), edtPassword.getText()
                    .toString().trim());
            if (isLogin) {
                ...
                Toast.makeText(this, "Email and password not found.", Toast.LENGTH_SHORT).show();
            }
        }
    }
}